...
//    public static String URL = "http://10.0.2.2:8080/"; //手机热点IP地址
    ...
    public static String URL_DELETENEEDINFORMATION = URL+"DeleteNeedInformation_Servlet";
    public static String URL_NEEDINFORMATION = URL+"NeedInformation_Servlet";
